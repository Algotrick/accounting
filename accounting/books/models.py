...
class TaxRate(models.Model):
    ...
    *inspired by Xero*
    """
    organization = models.ForeignKey('books.Organization', on_delete=models.CASCADE,
...
class EstimateLine(AbstractSaleLine):
    invoice = models.ForeignKey('books.Estimate', on_delete=models.CASCADE,
                                related_name="lines")
    tax_rate = models.ForeignKey('books.TaxRate', on_delete=models.CASCADE)
...
class BillLine(AbstractSaleLine):
    bill = models.ForeignKey('books.Bill', on_delete=models.CASCADE,
                             related_name="lines")
    tax_rate = models.ForeignKey('books.TaxRate', on_delete=models.CASCADE)
...
class ExpenseClaimLine(AbstractSaleLine):
    expense_claim = models.ForeignKey('books.ExpenseClaim', on_delete=models.CASCADE,
                                      related_name="lines")
    tax_rate = models.ForeignKey('books.TaxRate', on_delete=models.CASCADE,)
